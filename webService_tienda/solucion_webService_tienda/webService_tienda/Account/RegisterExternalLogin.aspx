<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="webService_tienda.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="webService_tienda" %>
