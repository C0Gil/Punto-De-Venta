<%@ Page Title="Comprobar número de teléfono" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="VerifyPhoneNumber.aspx.vb" Inherits="webService_tienda.VerifyPhoneNumber" %>
